...
A token is a piece of data sent by a server to a client when the user authenticates with the correct credentials.

- [ ] What steps can you take in your web apps to keep your data secure?

We can use authentication to make sure that only the users with proper credentials have access. We can also include password requirements of over 6 characters with specifics on uppercase letters, numbers, and symbols to enhance the protection of the user.

- [ ] Describe how web servers work.

A web server stores, processes, and delivers web page data to clients. The communication between the client and the server happens buy using HTTP or Hypertext Transfer Protocol.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

Put can map to the Update/Replace methods, Post can map to to the Create method, Get can map to the Read method, Patch can map to the Update/Modify method, and Delete can map to the Delete method.
